...
@Injectable()
export class HistoricoContratoService {
  constructor(
  ...
  getHistoricoByImovel(uidImovel): Observable<any> {
    return this.httpClient
      .get(
        environment.apiAutogestaoLocacao + 'contratos/getHistoricoByImovel',
        {
  ...
  getDetailsHistorico(uidContrato): Observable<any> {
    return this.httpClient
      .get(environment.apiAutogestaoLocacao + 'contratos/getDetailsHistorico', {
        headers: new HttpHeaders(this.requestOptions.getHeadersAuthorize()),
        params: {
          id: uidContrato
        }
